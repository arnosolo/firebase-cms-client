...
<template>
  <div @click="switchTheme" class="text-xl">
    <div v-if="theme === 'dark'" class="flex items-center gap-1">
      <div class="p-1">
        <svg t="1656209803684" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8964"
        class="w-4 h-4 fill-bright-contrastText stroke-bright-contrastText dark:fill-dark-contrastText"
        >
        <path
        ...
        <path
          ...
          fill="#FFCE54" p-id="8974"></path>
      </svg>
      </div>
    </div>
    <div v-else class="flex items-center gap-1">
      <svg t="1656209255435" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="7937"
        class="w-6 h-6 fill-bright-contrastText stroke-bright-contrastText dark:fill-dark-contrastText active:scale-95"
        >
        <path d="M501.48 493.55m-233.03 0a233.03 233.03 0 1 0 466.06 0 233.03 233.03 0 1 0-466.06 0Z" fill="#F9C626"
          p-id="7938"></path>
        <path
